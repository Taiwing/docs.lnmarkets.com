...
<table style="text-align:center">
  ...
  <tr>
    <td><bold><code>LNM-ACCESS-SIGN</code></bold</td>
...
- **`LNM-ACCESS-SIGN`** header is generated by creating a **sha256 HMAC** using the secret key on the prehash string `timestamp + method + path + params` (where + represents string concatenation).
- `timestamp` value is the same as the **`LNM-ACCESS-TIMESTAMP`** header. It <u>**MUST**</u> be number of seconds since Unix Epoch in UTC and it should be within 30 seconds of our API time.
